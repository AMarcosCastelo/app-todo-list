...
const todayContent = (element1, date) => {
   ...
   todayEl.innerHTML = 
   `
        <div class="today-content text-white">
            <div class="today-header mb-3 d-flex justify-content-between align-items-center">
                ...
                <button class="btnTodayPlus border-0 p-2">
            ...
            <div class="tableContent table-responsive">
                <table class="table">
                    <tbody class="tableToday text-white">

                    </tbody>
                <table>
            </div>
            <div class="today-body d-flex justify-content-center">
